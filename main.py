...
def main(window):
    ...
    objects = [*floor, Block(0, HEIGHT - block_size * 2, block_size),
               ...
               Block(block_size * 4.5, HEIGHT - block_size*3,block_size),
               Block(block_size*7,HEIGHT - block_size* 5.5,block_size),
               Block(block_size*9,HEIGHT - block_size*5,block_size),fire,fire3]
